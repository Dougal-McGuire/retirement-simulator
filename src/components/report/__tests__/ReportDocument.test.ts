...
const englishReportContent = {
  ...
  simulation: {
    ...
    effectiveRuns: 100,
    successDefinition: 'depletion',
    successRate: 0.85,
    depletionSuccessRate: 0.85,
    depletionRisk: 0.15,
    successCount: 85,
    horizonYears: 46,
    legacyTargetReal: 0,
    seedLabel: 'crn-0x5eedc0de',
    historicalPathCount: 125,
    historicalFirstYear: 1900,
    historicalLastYear: 2024,
    fromContext: true,
  },
  expenses: {
    horizonYears: 46,
    totalHorizonAmount: 2160000,
    scheduledExpenseTotal: 0,
    annualTotal: 48000,
    monthlyTotal: 4000,
    monthlyCategories: [
      {
