  ...
  return (
    <View>
          ...
          <View style={styles.card}>
            ...
            <Table>
              ...
              <TableRow>
                ...
                <TableCell width="45%" align="right">
                  {fmtPercent(assumptions.returnVolatility, 1, locale)}
                </TableCell>
              </TableRow>
              <TableRow>
              ...
              <TableRow>
                <TableCell width="55%">
                  {isGerman ? 'Inflationsvolatilität' : 'Inflation Volatility'}
                </TableCell>
                <TableCell width="45%" align="right">
                  {fmtPercent(assumptions.inflationVolatility, 1, locale)}
                </TableCell>
              </TableRow>
              <TableRow>
                <TableCell width="55%">
                  {isGerman ? 'Kapitalertragssteuer' : 'Capital Gains Tax'}
                </TableCell>
                <TableCell width="45%" align="right">
                  {fmtPercent(assumptions.capitalGainsTax / 100, 1, locale)}
                </TableCell>
              </TableRow>
              <TableRow>
                <TableCell width="55%">
                  {isGerman ? 'Entnahmestrategie' : 'Withdrawal Strategy'}
                </TableCell>
                <TableCell width="45%" align="right">
              ...
              {assumptions.withdrawalStrategy === 'vanguardDynamic' && (
                <>
                  <TableRow>
                    <TableCell width="55%">
                      {isGerman ? 'DS-Entnahmerate' : 'DS Withdrawal Rate'}
                    </TableCell>
                    <TableCell width="45%" align="right">
                      {fmtPercent(assumptions.dsWithdrawalRate, 2, locale)}
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell width="55%">{isGerman ? 'DS-Obergrenze' : 'DS Ceiling'}</TableCell>
                    <TableCell width="45%" align="right">
                      {fmtPercent(assumptions.dsCeilingRate, 1, locale)}
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell width="55%">{isGerman ? 'DS-Untergrenze' : 'DS Floor'}</TableCell>
                    <TableCell width="45%" align="right">
                      {fmtPercent(assumptions.dsFloorRate, 1, locale)}
                    </TableCell>
                  </TableRow>
                </>
              )}
        ...
        <View style={{ width: '32%', marginRight: '2%' }}>
          <View style={styles.card} wrap={false}>
            ...
            <Text style={styles.kpiDescription}>
              {isGerman ? 'Direkt aus Setup übernommen' : 'Derived from setup'}
            </Text>
          </View>
        </View>
        <View style={{ width: '32%', marginRight: '2%' }}>
          <View style={styles.card} wrap={false}>
            <Text style={styles.kpiLabel}>
              {isGerman ? 'Aktuelles Vermögen' : 'Current Assets'}
            </Text>
            <Text style={styles.kpiValue}>{fmtCurrency(finances.currentAssets, locale)}</Text>
            <Text style={styles.kpiDescription}>
              {isGerman ? 'Wert laut aktueller Eingabe' : 'Value from current input'}
            </Text>
          </View>
        </View>
        <View style={{ width: '34%' }}>
          <View style={styles.card} wrap={false}>
            ...
            <Text style={styles.kpiDescription}>
              {isGerman ? 'Monatlich + jährlich' : 'Monthly + annual expenses'}
            </Text>
          </View>
        </View>
      </View>
      ...
      <View
        style={[
          styles.card,
          { marginTop: 10, borderLeftWidth: 3, borderLeftColor: tokens.colors.accent[600] },
        ]}
      >
